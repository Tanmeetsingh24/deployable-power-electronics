...
1. **~97%** measured efficiency on buck-boost conversion paths used in deployment.
2. **Sub-2 ms** automatic switch between power sources under load.
3. Capacitor-based **UPS** layer to maintain continuity during brief input loss.
4. Reduced manual power intervention during deployable operations.

## My contribution

1. Designed and built **control / power-selection boards**, **buck-boost supplies**, and the **capacitor UPS** integration.
2. Owned bring-up and validation: load steps, source failover timing, and interaction with downstream equipment.
3. Worked across **power conversion, switching logic, embedded control**, and the systems being powered so the stack behaved as one product.
...
**Context:** [Portfolio](https://tanmeetsingh24.github.io), Cognitive Advantage, deployable power systems.
